...
```ts
import TestidSDKReact from 'final-sdk-react';
```
...
final-sdk-react is distributed under [AGPL-3.0-only](https://github.com/juspay/final-sdk-react/src/main/LICENSE.md) license.
